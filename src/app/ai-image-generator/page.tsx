...
export default function AIImageGeneratorPage() {
    ...
    return (
        <>
            <Navbar />
            <main>
                <section className="relative min-h-[70vh] flex items-center overflow-hidden bg-gradient-to-br from-pink-50 via-white to-rose-50 dark:from-slate-950 dark:via-slate-900 dark:to-slate-950">
                    ...
                    <div className="absolute bottom-[-10%] left-[-5%] w-[35%] h-[35%] bg-rose-500/8 rounded-full blur-[100px]" />
                    <div ref={heroRef} className="relative z-10 mx-auto max-w-7xl px-6 lg:px-8 py-32 lg:py-40">
                        <div className="max-w-3xl">
                            <span className="fade-up inline-flex items-center gap-2 rounded-full bg-pink-500/10 px-4 py-1.5 text-xs font-semibold uppercase tracking-widest text-pink-600 dark:text-pink-400 mb-6"><span className="h-1.5 w-1.5 rounded-full bg-pink-500 animate-pulse" />{p.heroBadge}</span>
