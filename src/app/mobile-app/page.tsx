        ...
        <>
            ...
            <main>
                <section className="relative min-h-[70vh] flex items-center overflow-hidden bg-gradient-to-br from-violet-50 via-white to-fuchsia-50 dark:from-slate-950 dark:via-slate-900 dark:to-slate-950">
                    ...
                    <div className="absolute top-[-10%] right-[-5%] w-[40%] h-[40%] bg-violet-500/8 rounded-full blur-[100px]" />
                    <div className="absolute bottom-[-10%] left-[-5%] w-[35%] h-[35%] bg-fuchsia-500/8 rounded-full blur-[100px]" />
                    <div ref={heroRef} className="relative z-10 mx-auto max-w-7xl px-6 lg:px-8 py-32 lg:py-40">
                        <div className="max-w-3xl">
                            <span className="fade-up inline-flex items-center gap-2 rounded-full bg-violet-500/10 px-4 py-1.5 text-xs font-semibold uppercase tracking-widest text-violet-600 dark:text-violet-400 mb-6">
                                <span className="h-1.5 w-1.5 rounded-full bg-violet-500 animate-pulse" />{p.heroBadge}
                            </span>
                            ...
                            <div className="fade-up fade-up-delay-3 mt-10 flex flex-col sm:flex-row gap-4">
                                ...
                                <a href="/#contact" className="inline-flex items-center justify-center gap-2 rounded-full border-2 border-slate-200 dark:border-slate-700 px-8 py-3.5 text-sm font-semibold hover:scale-105 transition-all text-[#0F172A] dark:text-white">{p.heroCta2}</a>
                            </div>
                        </div>
                    </div>
                </section>
