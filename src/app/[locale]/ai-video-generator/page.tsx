...
const THEME = {
    heroBg:
        "bg-[radial-gradient(circle_at_12%_18%,_rgba(255,123,123,0.18),_transparent_30%),radial-gradient(circle_at_82%_18%,_rgba(255,186,90,0.16),_transparent_26%),linear-gradient(180deg,_#26120f_0%,_#3f1d17_100%)]",
