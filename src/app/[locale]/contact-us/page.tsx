    ...
    },
    {
      ...
      value:
        locale === "id"
          ...
          : "Remote-first, clear rhythm, bilingual",
    },
  ];

  const fitPoints = [
    locale === "id"
      ? "Anda sudah punya masalah bisnis yang cukup jelas dan butuh partner eksekusi."
      : "You already have a business problem in view and need an execution partner.",
    locale === "id"
      ? "Anda ingin memilih lane produk, creative, CRM, atau app yang paling tepat."
      : "You want help choosing the right product, creative, CRM, or app lane.",
    locale === "id"
      ? "Anda butuh estimasi awal, proposal, atau diskusi scope tanpa proses bertele-tele."
      : "You need an early estimate, proposal, or scope discussion without a long detour.",
  ];
            ...
            <div className="max-w-2xl">
              ...
              <div className="mt-8 grid gap-4 sm:grid-cols-3 lg:grid-cols-1 xl:grid-cols-3">
                {responseCards.map((card) => (
                  <div
                    key={card.label}
                    className="rounded-[1.5rem] border border-slate-200 bg-white p-5 shadow-[0_12px_35px_rgba(15,23,42,0.05)] dark:border-white/10 dark:bg-white/[0.04]"
                  >
              ...
              <div className="mt-8 rounded-[1.8rem] border border-slate-200 bg-slate-950 p-6 text-white shadow-[0_22px_60px_rgba(15,23,42,0.16)] dark:border-white/10 dark:bg-white/[0.05]">
                <p className="text-[11px] font-semibold uppercase tracking-[0.18em] text-sky-300">
                  {locale === "id" ? "Best fit" : "Best fit"}
                </p>
                <p className="mt-4 text-2xl font-semibold tracking-[-0.03em]">
                  {locale === "id"
                    ? "Halaman ini dibuat untuk percakapan yang langsung bergerak."
                    : "This page is built for conversations that move quickly."}
                </p>
                ...
                <div className="mt-6 rounded-2xl border border-white/10 bg-white/[0.04] px-4 py-4">
                  ...
                  <a
                    ...
                    className="mt-3 block text-lg font-semibold text-white transition-colors hover:text-sky-300"
                  >
              ...
              {status === "success" ? (
                ...
                <form onSubmit={handleSubmit} className="flex flex-col gap-6">
                  <div className="rounded-[1.5rem] border border-slate-200 bg-slate-50 px-5 py-4 dark:border-white/10 dark:bg-white/[0.04]">
                    ...
                    <p className="mt-3 text-sm leading-7 text-slate-600 dark:text-slate-300">
                      {locale === "id"
                        ? "Semakin jelas konteks Anda, semakin cepat kami arahkan ke solusi, lane produk, atau scope yang relevan."
                        : "The clearer your context is, the faster we can point you to the right solution, product lane, or scope."}
                    </p>
                  </div>
