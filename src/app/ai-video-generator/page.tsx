...
export default function AIVideoGeneratorPage() {
    ...
    return (
        <>
            <Navbar />
            <main>
                <section className="relative min-h-[70vh] flex items-center overflow-hidden bg-gradient-to-br from-red-50 via-white to-orange-50 dark:from-slate-950 dark:via-slate-900 dark:to-slate-950">
                    <div className="absolute inset-0 bg-[url('https://grainy-gradients.vercel.app/noise.svg')] opacity-[0.02] dark:opacity-[0.04]" />
                    <div className="absolute top-[-10%] right-[-5%] w-[40%] h-[40%] bg-red-500/8 rounded-full blur-[100px]" />
                    <div className="absolute bottom-[-10%] left-[-5%] w-[35%] h-[35%] bg-orange-500/8 rounded-full blur-[100px]" />
                    <div ref={heroRef} className="relative z-10 mx-auto max-w-7xl px-6 lg:px-8 py-32 lg:py-40">
                        <div className="max-w-3xl">
                            <span className="fade-up inline-flex items-center gap-2 rounded-full bg-red-500/10 px-4 py-1.5 text-xs font-semibold uppercase tracking-widest text-red-600 dark:text-red-400 mb-6"><span className="h-1.5 w-1.5 rounded-full bg-red-500 animate-pulse" />{p.heroBadge}</span>
