      ...
      <div className="mx-auto grid min-h-[100dvh] w-full max-w-6xl items-center gap-10 px-5 py-8 lg:grid-cols-[1.1fr_0.9fr] lg:px-8">
        <section className="hidden lg:block">
          <div className="mb-16 text-2xl font-extrabold tracking-tight">
            plus<span className="text-sky-600">.</span>
          </div>

          <div className="max-w-xl">
            <p className="mb-4 inline-flex items-center gap-2 rounded-full border border-sky-200 bg-white px-3 py-1 text-xs font-semibold uppercase tracking-[0.18em] text-sky-700 shadow-sm">
            ...
            <p className="mt-5 max-w-md text-base leading-7 text-slate-600">
              Secure dashboard for the plus team. Built for daily work, not
              decoration.
            </p>
          </div>
        ...
        <section className="mx-auto w-full max-w-md">
          ...
          <div className="rounded-2xl border border-slate-200 bg-white p-7 shadow-[0_24px_80px_rgba(15,23,42,0.10)]">
            <div className="mb-7">
              <p className="text-sm font-medium text-sky-700">Secure sign in</p>
            ...
            <form onSubmit={onSubmit} className="space-y-4">
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full rounded-xl border border-slate-200 bg-slate-50 px-3 py-3 pl-10 text-sm text-slate-950 outline-none transition-colors placeholder:text-slate-400 focus:border-sky-400 focus:bg-white focus:ring-4 focus:ring-sky-100"
              ...
              {error && (
                <p
                  role="alert"
                  className="rounded-xl border border-rose-200 bg-rose-50 px-3 py-2.5 text-sm font-medium leading-5 text-rose-700"
                >
                  {error}
                </p>
              )}
              ...
              <button
                type="submit"
                disabled={loading}
                className="group flex w-full items-center justify-center gap-2 rounded-xl bg-slate-950 px-4 py-3 text-sm font-semibold text-white shadow-sm transition-all hover:bg-slate-800 active:translate-y-px disabled:cursor-not-allowed disabled:opacity-60"
              >
