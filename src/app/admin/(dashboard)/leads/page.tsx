...
export default async function LeadsPage({
  ...
  const unassignedCount = all.filter((lead) => !lead.owner?.trim()).length;
      ...
      <section className="overflow-hidden rounded-[2rem] border border-slate-200/80 bg-[radial-gradient(circle_at_top_left,_rgba(59,130,246,0.16),_transparent_30%),radial-gradient(circle_at_top_right,_rgba(244,114,182,0.12),_transparent_36%),linear-gradient(180deg,_rgba(255,255,255,0.98),_rgba(248,250,252,0.96))] p-6 shadow-[0_30px_80px_-50px_rgba(15,23,42,0.45)]">
        <div className="flex flex-wrap items-start justify-between gap-4">
          <div className="max-w-2xl">
            ...
            <h1 className="mt-4 text-3xl font-black tracking-tight text-slate-950">
              Leads yang paling panas, paling bernilai, dan paling butuh
              follow-up sekarang.
            </h1>
            <p className="mt-3 max-w-xl text-sm leading-6 text-slate-600">
              Prospek inbound per layanan, siap dikualifikasi, dibagi ke owner,
              lalu dikonversi jadi pipeline yang rapi.
            </p>
          </div>
        ...
        <div className="mt-6 grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
          ...
          <Link
            ...
            className="rounded-2xl border border-rose-200/80 bg-rose-50/90 p-5 transition-colors hover:bg-rose-100"
          >
          ...
          <div className="rounded-2xl border border-amber-200/80 bg-amber-50/90 p-5">
            ...
            <p className="mt-1 text-xs text-amber-800/70">
              {unassignedCount} belum punya owner
            </p>
          </div>
        </div>
      </section>
                  ...
                  <td colSpan={10} className="px-4 py-12 text-center">
                    <div className="mx-auto max-w-xs">
                      ...
                      <p className="mt-1 text-xs text-slate-300">
                        Lead akan muncul di sini saat prospek mengisi form atau
                        ditambahkan manual.
                      </p>
                    </div>
                  </td>
                    ...
                    <td className="px-4 py-3">
                      ...
                      {lead.source && (
                        <p className="text-[10px] text-slate-400">
                          {SOURCE_ICON[lead.source] ?? "TAG"} {lead.source}
                        </p>
                      )}
                    </td>
                    <td className="px-4 py-3">
