...
export default function Hero() {
    ...
    const metrics = [
        ...
        ["3.2x", locale === "id" ? "Ritme kirim lebih cepat" : "Faster shipping rhythm"],
    ];
    ...
    return (
        <section id="hero" className="relative overflow-hidden bg-[#f3f2ed] pt-28 text-slate-950 dark:bg-slate-950 dark:text-white">
                ...
                <div className="relative z-10 max-w-2xl">
                    ...
                    <div className="hero-animate hero-animate-delay-3 mt-9 flex flex-col gap-3 sm:flex-row">
                        <Link
                            ...
                            className="group inline-flex items-center justify-center gap-2 rounded-xl bg-slate-950 px-6 py-3 text-sm font-semibold text-white shadow-sm transition hover:bg-blue-700 active:translate-y-px dark:bg-white dark:text-slate-950 dark:hover:bg-blue-100"
                        >
                            {t.hero.ctaPrimary}
                    ...
                    <div className="hero-animate hero-animate-delay-3 mt-10 flex flex-wrap gap-3">
                        ...
                        <span className="rounded-full border border-slate-200 bg-white px-3.5 py-2 text-xs font-medium text-slate-600 dark:border-white/10 dark:bg-white/[0.04] dark:text-slate-300">
                            {locale === "id" ? "Satu ritme untuk banyak workflow" : "One rhythm for many workflows"}
                        </span>
                    </div>
                </div>

                <div className="hero-animate hero-animate-delay-2 relative z-10">
                    <div className="absolute -left-8 top-12 h-36 w-36 rounded-full bg-blue-300/20 blur-3xl" />
