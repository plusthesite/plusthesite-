...
export default function Products() {
    ...
    return (
        <section id="products" className="bg-white py-24 text-slate-950 lg:py-32 dark:bg-slate-950 dark:text-white">
                        ...
                        return (
                            ...
                            >
                                <div className="flex items-start justify-between gap-4">
                                    <span className="flex h-11 w-11 items-center justify-center rounded-xl bg-blue-50 text-blue-700 dark:bg-blue-400/10 dark:text-blue-300">
                                ...
                                <div className="mt-8 flex items-center gap-2 text-sm font-semibold text-blue-700 dark:text-blue-300">
