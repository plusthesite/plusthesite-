          ...
          >
                      ...
                      <div className="mt-2 flex flex-wrap gap-1.5">
                        {message.cta && (
                          <a
                            ...
                            className="rounded-full bg-primary px-3 py-1.5 text-xs font-semibold text-white transition-colors hover:bg-primary-dark"
                          >
                        ...
                        {message.quick?.map((quick, quickIndex) => (
                          <button
                            ...
                            className="rounded-full border border-slate-200 bg-white px-3 py-1.5 text-xs font-medium text-slate-600 transition-colors hover:border-primary hover:text-primary dark:border-slate-700 dark:bg-slate-800 dark:text-slate-300"
                          >
                            {quick[locale]}
                          </button>
                        ))}
            ...
            {busy && (
              <div className="flex justify-start">
                <div className="rounded-2xl rounded-bl-sm bg-white px-3.5 py-2.5 shadow-sm dark:bg-slate-800">
