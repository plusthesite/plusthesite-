...
export const translations = {
  en: {
    ...
    customerSupportPage: {
      ...
      ctaDesc: "Give every customer a faster, better answer — without growing your team.",
      ctaCta1: "Get a Free Quote",
    ...
    crmPage: {
      ...
      ctaDesc: "Turn more leads into customers with a CRM built around how you sell.",
      ctaCta1: "Get a Free Quote",
      ctaCta2: "Contact Sales",
    },
    ...
    aiTextPage: {
      ...
      ctaDesc: "Create more content in less time — without sacrificing quality.",
    ...
    chatBotPage: {
      ...
      ctaDesc: "Create better marketing content, faster — and stay consistent everywhere.",
      ctaCta1: "Get a Free Quote",
      ctaCta2: "Contact Sales",
    },
  ...
  id: {
    ...
    customerSupportPage: {
      ...
      heroCta1: "Minta Penawaran Gratis",
      heroCta2: "Pesan Demo",
      featuresBadge: "Fitur",
      ...
      ctaDesc: "Beri setiap pelanggan jawaban yang lebih cepat dan lebih baik — tanpa menambah tim.",
      ctaCta1: "Minta Penawaran Gratis",
    ...
    crmPage: {
      ...
      ctaDesc: "Ubah lebih banyak prospek jadi pelanggan dengan CRM yang sesuai cara Anda berjualan.",
      ctaCta1: "Minta Penawaran Gratis",
      ctaCta2: "Hubungi Sales",
    },
    ...
    aiTextPage: {
      ...
      ctaDesc: "Hasilkan lebih banyak konten dalam waktu lebih singkat — tanpa mengorbankan kualitas.",
    ...
    chatBotPage: {
      ...
      ctaDesc: "Buat konten marketing lebih baik dan lebih cepat — konsisten di semua channel.",
      ctaCta1: "Minta Penawaran Gratis",
      ctaCta2: "Hubungi Sales",
    },
