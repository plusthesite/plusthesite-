const en = {
    ...
    pricing: {
        ...
        plans: {
            starter: {
                ...
                annual: 2000000,
                features: [
                    "1 service line of your choice",
                    "AI chatbot or landing page setup",
                    "Monthly content (4 assets)",
            ...
            professional: {
                name: "Professional",
                tagline: "For growing brands that want momentum",
                monthly: 7500000,
                annual: 6000000,
                features: [
                    "Up to 3 service lines",
                    "AI chatbot + CRM integration",
                    "Weekly content & social media",
            ...
            enterprise: {
                name: "Enterprise",
                tagline: "For companies scaling with a dedicated team",
                monthly: 20000000,
                annual: 16000000,
                features: [
                    "Unlimited service lines",
                    "Custom app / game development",
    ...
    contact: {
        ...
        titleHighlight: "Build Together",
        subtitle: "Have a question, proposal, or project in mind? Fill out the form below and we will get back to you shortly.",
        nameLabel: "Name",
    ...
    payment: {
        ...
        subtitle: "Review your plan and continue to payment. Change or cancel anytime.",
        ...
        methodSubtitle: "Choose how you'd like to pay.",
        methodCard: "Credit / Debit Card",
        methodVA: "Bank Transfer (Virtual Account)",
        ...
        securedNote: "Payments are encrypted and processed securely.",
    },
    paymentRedirect: {
